...
#Vinicius Cayres Gago 22.120.037-1
...
Classificador = MLPClassifier(hidden_layer_sizes = (14), alpha=1, max_iter=2000)
...
ClassificadorPCA = MLPClassifier(hidden_layer_sizes = (14), alpha=1, max_iter=2000)
